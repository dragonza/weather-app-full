...
function Fog(props) {
  return (
    <svg viewBox="4231.384 -1107 1212.187 972">
      <defs>
        <filter
          id="a"
          x="4569.309"
      ...
      <g transform="translate(-205.628 -183)">
        <circle
          ...
          cy="486"
          r="486"
          transform="translate(4527.468 -924)"
        />
        <circle
          class="a"
          cx="413.822"
          cy="413.822"
          r="413.822"
          transform="translate(4599.646 -851.822)"
        />
        <circle
          class="a"
          cx="357.683"
          cy="357.683"
          r="357.683"
          transform="translate(4655.784 -795.683)"
        />
        <circle
          class="b"
          cx="307.549"
          cy="307.549"
          r="307.549"
          transform="translate(4706.008 -745.279)"
        />
        <g transform="translate(4514.646 -569.996)">
          <g transform="translate(6.814 37.733)">
            <rect
              ...
              height="5.958"
              rx="2.979"
              transform="translate(32.495 37.732)"
            />
            <rect
              class="c"
              width="172.435"
              height="5.958"
              rx="2.979"
              transform="translate(127.361 26.313)"
            />
            <rect
              class="c"
              width="172.435"
            ...
            <rect
              ...
              height="5.958"
              rx="2.979"
              transform="translate(233.757 0.496)"
            />
            <rect
              class="c"
              width="26.206"
              height="5.958"
              rx="2.979"
              transform="translate(59.75 26.313)"
            />
            <rect
              class="c"
              width="20.441"
              height="5.958"
              rx="2.979"
              transform="translate(254.198 51.137)"
            />
            <rect
              class="c"
              width="83.335"
              height="5.958"
              rx="2.979"
              transform="translate(56.605 51.137)"
            />
            <rect
              class="c"
              width="172.435"
            ...
            <rect
              ...
              height="5.958"
              rx="2.979"
              transform="translate(99.583 26.313)"
            />
            <rect
              class="c"
              width="172.435"
              height="5.958"
              rx="2.979"
              transform="translate(13.103 37.732)"
            />
            <rect
              class="c"
              width="172.435"
              height="5.958"
              rx="2.979"
              transform="translate(77.046 51.137)"
            />
          </g>
          <rect
            class="c"
